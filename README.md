...
- `backgrounds/` — 6 curated ink wash and enso wallpapers (`1.jpg` - `6.jpg`) featuring pine trees by Hasegawa Tohaku, gibbons in a landscape by Sesson Shukei, cypress trees by Kano Eitoku, snow mountains by Shiokawa Bunrin, dragons in waves by an 18th century Japanese screen painter, and sunset landscapes by Kagaku Murakami.
