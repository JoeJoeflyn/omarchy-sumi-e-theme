...
- `backgrounds/` — 6 curated ink wash and enso wallpapers (`1.jpg` - `6.jpg`) featuring enso circles, pine trees by Hasegawa Tohaku, and zen landscapes.
- `icons.theme` — Set to `Yaru-red` for matching folder and file manager icons.
- `unlock.png` & `preview-unlock.png` — Full-screen Hasegawa Tohaku Pine Trees ink wash painting for Plymouth boot and lock screens.
